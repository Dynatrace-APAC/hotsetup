...
#      ----- Install utilities -----               #
# ==================================================
echo "--Install openjdk-17-jdk openjdk-17-jre-headless openjdk-17-source jq nginx maven python3-pip--"
apt update && apt -qy upgrade
apt -y install openjdk-17-jdk openjdk-17-jre-headless openjdk-17-source jq nginx maven python3-pip
echo "--end--"
